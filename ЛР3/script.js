...
function addblockForSecondTask()
{
    var param = getRandomParam();
    var figure = document.createElement('div');
    figure.style.backgroundColor = getRandomColor();
...
function generalPart ()
{
    ...
    statButton.innerText ="Stats";
    podpis1.innerText ="To the begining"; 
    podpis2.innerText ="To the end";
...
function add()
{
    ...
    if(part == 2 )
    {
        addblockForSecondTask();
    }
	if(part ==3)
	{
		addblockForTherdTask();
	}
